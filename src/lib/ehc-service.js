...
const baseUrl = process.env.EHC_BASE_URL || "https://hcq.payrollq.id/prweb/api/EHC/v1";
const EHC_GETDATA_URL = baseUrl.endsWith("/GetDataEHC") ? baseUrl : `${baseUrl}/GetDataEHC`;
